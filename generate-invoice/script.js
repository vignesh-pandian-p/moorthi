  ...
  import { doc,getDoc, setDoc, getFirestore,query , getDocs, collection } from "https://www.gstatic.com/firebasejs/9.22.1/firebase-firestore.js";
...
async function generatePaymentNumber() {
    ...
    if (docSnap.exists()) {
        ...
        paymentNumber = `PK${String(nextNumber).padStart(10, "0")}`;
    }
...
document.getElementById("generateInvoice").addEventListener("click",async () => {
    ...
    try {
        ...
        const customerDetails = {
            customerName,amount,amountInWords, paymentMode, paymentDate,paymentNumber,timestamp
        }
